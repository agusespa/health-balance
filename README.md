...
- **AI-Powered Insights**: (Optional) Get personalized health summaries and recommendations generated by Gemini.
...
- `GEMINI_API_KEY`: (Optional) Your Google AI Studio API key. Required to enable the **AI Health Summary** feature.
